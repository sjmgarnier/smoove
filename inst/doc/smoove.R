...
## ----FirstPlot, echo=-1, fig.height=3, fig.width = 6--------------------------
...
## ----ucvm.exact, echo=-1, fig.height=4, fig.width = 6, echo = -1--------------
set.seed(2)
...
## ----plotRACVM, echo=-1, fig.height=4, bty="l", fig.width = 6-----------------
...
## ----EVAFplots, echo = -1, fig.width=6, fig.height = 6------------------------
...
## ----VAF1, fig.height=4, echo=-1, fig.width = 6-------------------------------
...
## ----acvm, echo=FALSE, fig.height = 3, fig.width = 6--------------------------
...
## ----racvm, echo=-1, fig.height = 3, fig.width = 6----------------------------
par(bty="l", mgp = c(1.5,0.25,0), tck=0.01, las=1); plot_track(racvm$Z)

## ----racvm.fit, size = "footnotesize"-----------------------------------------
...
## ----K1, echo=-1, fig.height=4, fig.width = 8---------------------------------
...
## ----K1.sim, echo=-1, fig.height=4, fig.width = 8-----------------------------
par(mar = c(0,2,0,0), oma = c(4,4,2,2), bty="l")
...
## ----TwoPhaseCVM, fig.height = 4, echo=-1, fig.width = 6, fig.align="center"----
par(bty="l")
...
## ----fig.height = 4, echo=-1, fig.width = 6-----------------------------------
par(bty="l")
...
## ----plotMulticvm, echo =-1, fig.height = 4, fig.width = 6, fig.align="center"----
...
## ----simSweep.parallel, warning = FALSE, eval=FALSE, message = FALSE----------
#  require(foreach); require(doFuture)
#  registerDoFuturel()
#  plan(multisession)
...
## ----sweepKestrel, message=FALSE, eval = FALSE--------------------------------
